...
class ContentViewController : NSViewController {
    ...
    override func loadView() {
        ...
        view.addConstraints(NSLayoutConstraint.constraints(
            withVisualFormat: "H:|-(20)-[searchField]-(20)-|", options: [], metrics: nil, views: ["searchField":searchField]))
        view.addConstraints(NSLayoutConstraint.constraints(
            withVisualFormat: "V:|-(20)-[searchField(==30)]", options: [], metrics: nil, views: ["searchField":searchField]))
    }
